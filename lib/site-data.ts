...
export const siteData: SiteData = {
  ...
  content: {
    ...
    projects: [
      {
        title: "EzParkk",
        description: "Peer-to-peer parking app that hit 50k impressions in 3 weeks and trended #1 on the UCI subreddit after spreading organically. Shipped from concept to App Store in under 20 weeks with 99.9% uptime.",
        tags: [
          "iOS",
          "Swift",
          "Product",
        ],
        impact: "50k impressions in 3 weeks",
      },
      {
      ...
      },
      {
        ...
        impact: "Beat SPY by 300% over 8 years",
      ...
      },
      {
        ...
        impact: "150+ downloads, 22 countries",
      },
      {
        title: "DepthDiver",
        ...
        link: "https://github.com/SanjoyDat1/DepthDiver",
        mediaUrl: "https://socialify.git.ci/SanjoyDat1/DepthDiver/image?theme=Light&pattern=Plus&font=Inter&description=1&owner=1",
      },
      {
        title: "Opennote iOS",
        description: "An iOS prototype for Opennote, the notebook that thinks with you. Early exploration of agentic AI for note-taking on mobile platforms.",
        tags: [
          "Swift",
          "iOS",
          "AI",
        ],
        link: "https://github.com/SanjoyDat1/Opennote_iOS",
        mediaUrl: "https://socialify.git.ci/SanjoyDat1/Opennote_iOS/image?theme=Light&pattern=Plus&font=Inter&description=1&owner=1",
      },
    ],
    ctaText: "Follow my work",
    avatarUrl: "https://avatars.githubusercontent.com/u/77421859?v=4",
    bio: "I'm an iOS founder and student who builds products that solve real inefficiencies. I shipped EzParkk from concept to App Store in under 20 weeks—it hit 50k impressions in 3 weeks and trended #1 on the UCI subreddit after spreading organically through a post I didn't even make. I focus on mobile-first experiences and AI that feels proactive without interrupting you, like SunnyD NoteTaker, where the hardest challenge was making it helpful without being annoying.\n\nI learn in public, iterate fast, and don't wait for permission. I've published apps across 22 countries, built trading bots that beat SPY by 300% over 8 years, and I'm always working on the next thing. If it solves a real problem and I can ship it, I'm in.",
    heroMediaUrl: null,
    ...
    location: null,
    subheadline: "Building mobile-first products that spread organically and AI tools that stay out of your way.",
    gallery: [],
